...
countriesInfo.map((country) => {
    ...
    info.className = 'info';
    info.innerHTML = `
        <h2><span class='side-heading'></span>${country.name}</h2>
        <p><span class='side-heading'>Population:</span>${country.population}</p>
        <p><span class='side-heading'>Region:</span>${country.region}</p>
         <p><span class='side-heading'>Capital:</span>${country.capital}</p>
    `
